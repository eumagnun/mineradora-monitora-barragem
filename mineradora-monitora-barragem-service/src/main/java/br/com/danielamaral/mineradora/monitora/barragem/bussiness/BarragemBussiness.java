...
public class BarragemBussiness {
	...
	public Barragem registrarMonitoramento(long idBarragem, AtributoMonitoramento atributoMonitoramento) {
		Optional<Barragem> barragem = barragemRepository.findById(idBarragem);
		barragem.get().addAtributoMonitoramento(atributoMonitoramento);
		barragemRepository.save(barragem.get());
		return  barragem.get();
	}
}
